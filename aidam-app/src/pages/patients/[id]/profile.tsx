...
const profile = () => {
  ...
  useEffect(() => {
    setAsd(router.query.id ? router.query.id.toString() : '');
  ...
  return (
    <div className='flex flex-col px-3.5'>
      ...
      <div className='flex flex-col px-2.5'>
        ...
        <Data icon={professionLogo} title={'Obra social'} info={'OSEP'}></Data>
        <Data
          icon={licenseIcon}
          title={'N° de afiliado'}
          info={'3/336299232/01'}
      ...
      <div className='flex flex-col px-2.5 mb-4'>
        ...
        ></Data>
        <Data icon={phoneIcon} title={'Teléfono'} info={'234-1231123'}></Data>
      </div>
    </div>
  );
};
