    ...
    <div className={`flex flex-col ${divclass}`}>
      <label
        ...
        className={`${labelclass} ${
          labelclass?.includes('text') ? '' : 'text-ln'
        } font-medium mb-2`}
      >
        {label}
      </label>
      <TextareaAutosize
        ...
        value={value}
        onChange={onChange}
        className='rounded-md p-1.5 w-full shadow-xm resize-none outline-none border border-gray-100 hover:border-aidam80 transition-colors'
      />
    </div>
  );
};
  ...
  return (
    <div className={`flex ${divclass} items-center`}>
      ...
      <input
        ...
        value={value}
        onChange={onChange}
        className='outline-none border border-background hover:border-aidam80 rounded-md transition-colors'
      />
    </div>
  );
};
